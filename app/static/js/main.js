/**
 * LandPr - Основной JavaScript
 * Анимации, формы, уведомления
 */
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (response.ok && result.ok) {
                    ...
                    // Ошибка
                    showNotification('❌ ' + (result.detail || 'Ошибка отправки'), 'error');
    ...
    console.log('✅ LandPr готов к работе!');
});